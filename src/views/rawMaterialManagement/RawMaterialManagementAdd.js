...
const RawMaterialManagementAdd = () => {
    ...
    const handleFormSubmit = async (data) => {
        try {
            ...
            setLoading(true)
            await RawMaterialManagementService.add(data)
            await HistoryService.add(`add raw material ${data.materialCode}`)
            setToast(
                <CToast autohide={3000} visible className="text-dark">
                    ...
                    <CToastBody>
                        Raw material create successfully.
                    </CToastBody>
                </CToast>
            );
            setTimeout(() => {
                    ...
                    <CRow>
                        <CCol xs={12}>
                            <CCard className="mb-4">
                                <CCardHeader>
                                    <strong>Add Raw Material Management</strong>
                                </CCardHeader>
                                <CCardBody>
                                    <CForm onSubmit={handleSubmit(handleFormSubmit)}>
                                        ...
                                        <div className="mb-3">
                                            ...
                                            <CFormInput {...register("materialName", { required: "Material name is required" })} />
...
export default RawMaterialManagementAdd
