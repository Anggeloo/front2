...
const MonthlySummaryAdd = () => {
    ...
    const handleFormSubmit = async (data) => {
        try {
            ...
            setLoading(true)
            await MonthlySummaryService.add(data)
            await HistoryService.add(`add monthly summary ${data.summaryCode}`)
            setToast(
                <CToast autohide={3000} visible className="text-dark">
                    ...
                    <CToastBody>
                        Monthly summary create successfully.
                    </CToastBody>
                </CToast>
            );
            setTimeout(() => {
                    ...
                    <CRow>
                        <CCol xs={12}>
                            <CCard className="mb-4">
                                <CCardHeader>
                                    <strong>Add Monthly Summary</strong>
                                </CCardHeader>
                                <CCardBody>
...
export default MonthlySummaryAdd
