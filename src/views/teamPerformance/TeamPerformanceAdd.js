...
const TeamPerformanceAdd = () => {
    ...
    const handleFormSubmit = async (data) => {
        try {
            ...
            setLoading(true)
            await TeamPerformanceService.add(data)
            await HistoryService.add(`add team performance ${data.teamCode}`)
            setToast(
                <CToast autohide={3000} visible className="text-dark">
                    ...
                    <CToastBody>
                        Team performance create successfully.
                    </CToastBody>
                </CToast>
            );
            setTimeout(() => {
                    ...
                    <CRow>
                        <CCol xs={12}>
                            <CCard className="mb-4">
                                <CCardHeader>
                                    <strong>Add Team Performance</strong>
                                </CCardHeader>
                                <CCardBody>
...
export default TeamPerformanceAdd
